...
public class AppWebConfiguration extends WebMvcConfigurerAdapter{
	...
	/**
	 * Responsável por resolver o retorno, se JSON ou html.
	 */
	@Bean
	...
	/**
	 * Responsável por informar ao Spring qual servlet irá capturar as
	 *  requisições default, como CSS, javascript etc (pacote resource).
	 */
	@Override
